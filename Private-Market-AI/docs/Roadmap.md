...
**Level:** 🧭 **[NORTH STAR — private]** — the full roadmap. For outreach, show only Paper #1 → #2
(use `Outreach_Brief.md`). This document is your compass, not a pitch deck.
...
```
2026  Explainable ML for Startup Valuation      → paper (done, WI2026)
2027  Private Market Data Model                  → RFC + paper (foundational)
2028  Knowledge Graph for Private Markets         → paper + prototype
2029  Multimodal Startup Representation            → paper
2030  AI Due Diligence Copilot                     → paper + product V2
2031  Investment Committee Copilot                 → paper + product V3
2033+ Private Market Operating System              → platform / company
```
...
- **M1 (30 days):** academic profile live; 5 outreach emails sent.
- **M2 (3 months):** ≥2 warm research contacts; Data Model v0.1 drafted.
- **M3 (6 months):** collaboration or RA role secured; Paper #2 in progress.
- **M4 (12 months):** grant host confirmed; grant proposal in preparation.
- **M5 (24 months):** 2–3 papers; grant secured; spin-off feasibility assessed.
