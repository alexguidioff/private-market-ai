...
> **Disclosure discipline:** NORTH STAR docs = for me only (compass). OUTREACH docs = for
> professors. Pitch only Paper #1 (done) → Paper #2 (data model). Never the full roadmap.
