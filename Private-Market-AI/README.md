...
- **OUTREACH (public)** — what a professor actually sees: an accepted paper + one clear research
  question + a concrete idea for **Paper #2**. That's it.
...
- **For professors (now):** use only `Outreach_Brief.md` + the WI2026 one-pager. Talk about the
  paper and Paper #2 (the Private Market Data Model). Nothing more.
