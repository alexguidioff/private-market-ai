...
> professors, present only the accepted foundational study and P1 (cost-aware Value of Information,
> with the point-in-time representation as enabling infrastructure); see `../Outreach_Brief.md`.
> The bigger the vision, the less of it you show early (Chapter 1, §0.1).
...
**How it is pursued.** The accepted foundational study leads to **P1, cost-aware Value of
Information for VC diligence**, with a public point-in-time data layer and a synthetic ground-truth
test harness as enabling assets. P2 studies decision quality and P3 human-AI committees; later work
on gaming and portfolio VoI is conditional on P1. A benchmark beyond VCBench is secondary, not a
