...
```mermaid
flowchart TB
    F0["F0 Valuation<br/>WI2026 accepted"] --> P1["P1 Cost-aware VoI<br/>flagship"]
    PIT["PiT public data<br/>+ executable schema"] --> P1
    SIM["Synthetic test harness<br/>known ground truth"] --> P1
    P1 --> P2["P2 Decision Quality"]
    P1 --> P3["P3 Human-AI Committee"]
    P1 --> P4["P4 Gaming Robustness<br/>continuation"]
    P1 --> P5["P5 Portfolio VoI<br/>continuation"]
    DG["Decision Graph"] -. "enables" .-> P2
    DG -. "enables" .-> P3
    class F0 done;
    classDef done fill:#d9ead3,stroke:#38761d;
```
*Caption: the accepted foundational study leads to P1, the flagship test of cost-aware information
acquisition. PiT data and the synthetic harness are enabling assets; P2–P5 depend on evidence from P1.*
