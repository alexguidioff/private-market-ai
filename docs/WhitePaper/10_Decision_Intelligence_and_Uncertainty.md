...
> value of information `[voi-howard]` (Howard 1966, IEEE Trans. SSC — ✅ verified).

## To do for this chapter
- [x] Decision-science / causality citations added (Pearl, Savage, Tversky-Kahneman).
- [x] Value-of-information (Howard 1966, IEEE Trans. SSC) finalised ✅ · [ ] calibration reference still TODO.
