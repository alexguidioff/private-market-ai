...
- **Implication:** the *idea* of decision-quality ML is no longer virgin territory, but **applying it
  ...
  open. Must cite the Management Science 2025 framework (Dong, Saar-Tsechansky & Geva) as the anchor.
...
2. **Decision-quality measurement for VC** (process vs outcome, via Decision Graph) — 🟢 open in
   finance/VC; anchor to Mgmt Science 2025 expert-decision-quality framework (Dong, Saar-Tsechansky & Geva).
...
- **Verdict:** open, but crowded *around* it. Must anchor to Mgmt Science 2025 expert-DQ framework (Dong, Saar-Tsechansky & Geva)
...
| P3 Decision Quality | 🟡 open-ish | process-vs-outcome DQ for VC | Mgmt Science 2025 (Dong et al.); leakage-aware VC ranking (MDPI) |
